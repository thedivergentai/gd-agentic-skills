...
|-------|--------|---------|
| 1. Net | `multiplayer-networking` | Authoritative server, lag compensation |
| 2. Map | `3d-world-building`, `level-of-detail` | Large terrain, chunking, distant trees |
| 3. Items | `inventory-system` | Managing backpack, attachments, armor |
