...
| 2. AI | `navigation-pathfinding` | Minion waves, Tower aggro logic |
| 3. Combat | `ability-system`, `rpg-stats` | QWER abilities, cooldowns, scaling |
| 4. Network | `multiplayer-networking` | Authority, lag compensation, prediction |
| 5. Map | `3d-world-building` | Lanes, Jungle, River, Bases |
