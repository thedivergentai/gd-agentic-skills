...
| 2. AI | `steering-behaviors`, `state-machine-advanced` | Formations, marking, flocking |
| 3. Anim | `animation-tree-mastery` | Blended running, shooting, tackling |
| 4. Input | `input-mapping` | Contextual buttons (Pass/Tackle share button) |
| 5. Camera | `camera-systems` | Dynamic broadcast view, zooming on action |
