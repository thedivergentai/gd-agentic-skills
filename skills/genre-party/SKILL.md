...
| 2. Scene | `scene-management` | Loading/Unloading minigames cleanly |
| 3. Data | `resource-data-patterns` | Defining minigames via Resource files |
| 4. UI | `ui-containers` | Scoreboards, instructions screens |
| 5. Logic | `turn-system` | Managing the "Board Game" phase |
