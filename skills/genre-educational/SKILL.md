...
|-------|--------|---------|
| 1. UI | `ui-rich-text`, `ui-theming` | Readable text, drag-and-drop answers |
| 2. Data | `save-load-systems`, `json-serialization` | Student profiles, progress tracking |
| 3. Logic | `state-machine` | Quiz flow (Question -> Answer -> Result) |
| 4. Juice | `particles`, `tweening` | Making learning feel rewarding |
| 5. Meta | `scene-management` | Navigating between lessons and map |
...
*   **Visuals**: Screen shake, particles, multiplier popup.
