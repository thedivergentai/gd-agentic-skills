...
### [skill_indexer.gd](../scripts/godot-skill-discovery_skill_indexer.gd)
...
### [skill_index_generator.gd](../scripts/godot-skill-discovery_skill_index_generator.gd)
...
- **NEVER conflate "Similar" skills** — Ensure `godot-composition` and `godot-composition-apps` have distinct enough keywords that the discovery system doesn't return the wrong one for a game-logic vs. UI-logic request.
...
1. **Weight 10**: Exact Name Match (e.g., query "tweening" vs. name "godot-tweening").
