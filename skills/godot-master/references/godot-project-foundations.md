...
> **MANDATORY - For New Projects**: Before scaffolding, read [`project_bootstrapper.gd`](../scripts/godot-project-foundations_project_bootstrapper.gd) - Auto-generates feature folders and .gitignore.

### [project_bootstrapper.gd](../scripts/godot-project-foundations_project_bootstrapper.gd)
Expert project scaffolding tool for auto-generating feature folders and .gitignore.

### [scene_naming_validator.gd](../scripts/godot-project-foundations_scene_naming_validator.gd)
Scans entire project for snake_case/PascalCase violations. Run before PRs.

### [dependency_auditor.gd](../scripts/godot-project-foundations_dependency_auditor.gd)
Detects circular scene dependencies and coupling issues. Critical for projects >50 scenes.

### [feature_scaffolder.gd](../scripts/godot-project-foundations_feature_scaffolder.gd)
