...
### [vfx_port_shader.gdshader](../scripts/godot-shaders-basics_vfx_port_shader.gdshader)
Expert shader template with parameter validation and common effect patterns for 2D/3D.

### [shader_parameter_animator.gd](../scripts/godot-shaders-basics_shader_parameter_animator.gd)
