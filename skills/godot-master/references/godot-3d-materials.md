...
### [material_fx.gd](../scripts/godot-3d-materials_material_fx.gd)
...
### [pbr_material_builder.gd](../scripts/godot-3d-materials_pbr_material_builder.gd)
Runtime PBR material creation with ORM textures and triplanar mapping.

### [organic_material.gd](../scripts/godot-3d-materials_organic_material.gd)
Subsurface scattering and rim lighting setup for realistic organic surfaces (skin, leaves, etc.).

### [triplanar_world.gdshader](../scripts/godot-3d-materials_triplanar_world.gdshader)
