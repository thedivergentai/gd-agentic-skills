...
See example script: [health_component.gd](../scripts/godot-composition_health_component.gd)

### The Hitbox Component
Simple hitbox logic for collision detection.
See example script: [hitbox_component.gd](../scripts/godot-composition_hitbox_component.gd)
