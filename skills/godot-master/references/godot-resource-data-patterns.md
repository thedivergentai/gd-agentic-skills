...
### [data_factory_resource.gd](../scripts/godot-resource-data-patterns_data_factory_resource.gd)
Expert resource factory with type validation and batch instantiation.

### [resource_pool.gd](../scripts/godot-resource-data-patterns_resource_pool.gd)
Object pooling for Resource instances - reduces allocation overhead in hot paths.

### [resource_validator.gd](../scripts/godot-resource-data-patterns_resource_validator.gd)
Validates Resource files for missing exports and configuration issues.

> **MANDATORY - For Data Systems**: Read [data_factory_resource.gd](../scripts/godot-resource-data-patterns_data_factory_resource.gd) before implementing item/stat databases.
