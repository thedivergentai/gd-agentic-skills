...
### [hsm_logic_state.gd](../scripts/godot-state-machine-advanced_hsm_logic_state.gd)
Expert HSM base class with state stack management and validation.

### [pushdown_automaton.gd](../scripts/godot-state-machine-advanced_pushdown_automaton.gd)
Stack-based state machine for interrupt-resume behavior (pause menus, cutscenes).

> **MANDATORY**: Read [hsm_logic_state.gd](../scripts/godot-state-machine-advanced_hsm_logic_state.gd) before implementing hierarchical AI behaviors.
