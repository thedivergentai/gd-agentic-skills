...
### [async_scene_manager.gd](../scripts/godot-scene-management_async_scene_manager.gd)
...
### [scene_state_manager.gd](../scripts/godot-scene-management_scene_state_manager.gd)
Preserves and restores scene state across transitions using "persist" group pattern.

> **MANDATORY - For Smooth Transitions**: Read [async_scene_manager.gd](../scripts/godot-scene-management_async_scene_manager.gd) before implementing loading screens.
