...
|-------|--------|---------|
| 1. Atmosphere | `3d-lighting`, `audio-systems` | Volumetric fog, dynamic shadows, spatial audio |
| 2. AI | `state-machine-advanced`, `navigation-pathfinding` | Hunter AI, sensory perception |
| 3. Player | `characterbody-3d` | Leaning, hiding, slow movement |
| 4. Scarcity | `inventory-system` | Limited battery, ammo, health |
