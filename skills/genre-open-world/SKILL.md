...
|-------|--------|---------|
| 1. Tera | `3d-world-building`, `shaders` | Large scale terrain, tri-planar mapping |
| 2. Opti | `level-of-detail`, `multithreading` | HLOD, background loading, occlusion |
| 3. Data | `save-load-systems` | Saving state of thousands of objects |
| 4. Nav | `navigation-pathfinding` | AI pathfinding on large dynamic maps |
