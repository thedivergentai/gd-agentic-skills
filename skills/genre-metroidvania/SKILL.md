...
|-------|--------|---------|
| 1. Character | `characterbody-2d`, `state-machines` | Tight, responsive movement (Coyote time, buffers) |
| 2. World | `tilemap-mastery`, `level-design` | Interconnected map, biomes, landmarks |
| 3. Systems | `save-load-systems`, `scene-management` | Persistent world state, room transitions |
| 4. UI | `ui-system`, `inventory-system` | Map system, inventory, HUD |
