...
|-------|--------|---------|
| 1. Grid/Path | `tilemap-mastery`, `navigation-2d` | Defining where enemies walk and towers build |
...
### 1. Wave Manager
Handles the timing and composition of enemy waves.
