...
|-------|--------|---------|
| 1. Math | `gdscript-mastery` | Handling numbers larger than 64-bit float |
| 2. UI | `ui-containers`, `labels` | Displaying "1.5e12" or "1.5T" cleanly |
| 3. Data | `save-load-systems` | Saving progress, offline time calculation |
