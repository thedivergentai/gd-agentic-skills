...
| 2. World Gen | `procedural-generation`, `tilemap`, `noise` | Creating unique levels every run |
| 3. Combat | `combat-system`, `enemy-ai` | Fast-paced, high-stakes encounters |
| 4. Progression | `loot-tables`, `inventory-system` | Managing run-specific items/relics |
