...
|-------|--------|---------|
| 1. Interaction | `input-handling`, `raycasting` | Clicking, dragging, grid movement |
| 2. Logic | `command-pattern`, `state-management` | Undo/Redo, tracking level state |
| 3. Feedback | `tweening`, `juice` | Visual confirmation of valid moves |
| 4. Progression | `save-load-systems`, `level-design` | Unlocking levels, tracking stars/score |
